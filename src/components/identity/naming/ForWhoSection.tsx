...
const items = [
  {
    number: '01',
    text: "Chi sta fondando una nuova azienda o lanciando un nuovo prodotto e vuole un nome che funzioni nel lungo periodo — non solo il primo nome che sembra carino.",
  },
  {
    number: '02',
    text: "Chi ha già un nome che non funziona più: troppo generico, difficile da pronunciare, con accezioni negative in altri mercati o semplicemente datato.",
  },
  {
    number: '03',
    text: "Chi gestisce un portfolio di prodotti con naming disorganico e ha bisogno di costruire un sistema coerente.",
  },
];
  ...
  return (
    <section ref={sectionRef} className="w-full bg-black px-6 py-24 md:py-36">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="inam-forwho-title mb-16">
        ...
        <div className="divide-y divide-white/[0.06]">
          {items.map((item) => (
            <div
              key={item.number}
              className="inam-forwho-item flex items-start gap-8 md:gap-16 py-10 md:py-12 group"
            >
