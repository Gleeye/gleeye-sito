const words = [
  'Video Istituzionale', 'Spot ADV', 'Video Prodotto', 'Explainer',
  'Social Video', 'Motion Graphic', 'Color Grading', 'Sound Design',
  'Pre-produzione', 'Post-produzione', 'Reels', 'Short Form',
  ...
  return (
    <div className="w-full bg-black border-y border-white/[0.06] py-5 overflow-hidden">
      <div
        ...
        style={{ animation: 'marquee-video 28s linear infinite' }}
      >
        {doubled.map((word, i) => (
