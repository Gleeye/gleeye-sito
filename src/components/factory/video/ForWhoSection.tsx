...
const items = [
  {
    number: '01',
    text: 'Chi sa che un video professionale farebbe la differenza, ma finora ha rimandato pensando che fosse troppo costoso o complicato da gestire.',
  },
  {
    number: '02',
    text: 'Chi produce video internamente con risultati mediocri — qualità delle riprese, montaggio improvvisato, assenza di sound design — e vuole fare il salto.',
  },
  {
    number: '03',
    text: 'Chi ha bisogno di contenuti video continuativi per i social, ma non ha le risorse per una produzione in-house strutturata.',
  },
];
  ...
  return (
    <section ref={sectionRef} className="w-full bg-black px-6 py-24 md:py-36">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="gvid-forwho-title mb-16">
        ...
        <div className="divide-y divide-white/[0.06]">
          {items.map((item) => (
            <div
              key={item.number}
              className="gvid-forwho-item flex items-start gap-8 md:gap-16 py-10 md:py-12 group"
            >
