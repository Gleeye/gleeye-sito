...
const stats = [
  { value: '500+', label: 'Servizi fotografici', sub: 'tra reportage, prodotto ed editorial' },
  { value: '10+',  label: 'Anni sul campo',       sub: 'su settori e scale molto diversi' },
  { value: '40+',  label: 'Brand nel portfolio',  sub: 'dalla PMI al cliente enterprise' },
  { value: '0',    label: 'Foto stock',            sub: 'tutto ciò che consegniamo è originale' },
];

export default function FotografiaStatsSection() {
  ...
  return (
    <section ref={sectionRef} className="w-full bg-[#F8F9FA] px-6 py-20 md:py-28 border-b border-black/[0.05]">
      <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-px bg-black/[0.05]">
        {stats.map((s) => (
          <div key={s.value} className="fstat-item bg-[#F8F9FA] px-8 py-10 md:px-12 md:py-14 flex flex-col gap-3">
            <span
