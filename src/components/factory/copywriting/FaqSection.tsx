...
const faqs = [
  {
    q: 'Quanto tempo richiede un progetto di copywriting?',
    a: 'Dipende dal perimetro. Un sito vetrina (5-7 pagine) richiede in genere 2-3 settimane dal brief approvato. Contenuti singoli (landing page, campagna) anche meno. Definiamo le tempistiche nel preventivo.',
  },
  {
    q: 'Lavorate anche su testi già esistenti o solo su copy da zero?',
    a: 'Entrambi. Spesso il lavoro più efficace è un\'audit + riscrittura del materiale esistente: manteniamo ciò che funziona, eliminiamo il rumore, rafforzoriamo i punti deboli.',
  },
  {
    q: 'Come gestite il tono di voce se non ne abbiamo uno definito?',
    a: 'Partiamo da zero insieme. Attraverso un workshop di positioning e alcune sessioni di brief, costruiamo le linee guida verbali del brand prima di scrivere una riga.',
  },
  {
    q: 'Lavorate solo in italiano?',
    a: 'Produciamo copy in italiano. Per progetti in lingua inglese o altre lingue, collaboriamo con copywriter madrelingua selezionati — garantendo lo stesso standard qualitativo.',
  },
  {
    q: 'Il copywriting include ottimizzazione SEO?',
    a: "Sì, su richiesta. Per i contenuti web e i blog post integriamo keyword research e ottimizzazione on-page. Il copy rimane leggibile per le persone — la SEO è una conseguenza, non un'ossessione.",
  },
];
