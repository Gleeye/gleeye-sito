...
const WORDS = ['IL', 'DESIGN', 'NON', 'MENTE'];

export default function GraficaHeroSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="ggra-hero relative min-h-[100dvh] w-full bg-black flex flex-col justify-between px-6 pt-32 pb-12 md:pt-40 md:pb-24 overflow-hidden"
    >
      {/* Gradient orbs */}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center flex-1 py-12 text-center">
        ...
        <p ref={subRef} className="mt-8 max-w-xl font-jakarta font-medium text-lg md:text-xl text-white/30 leading-relaxed">
          Ogni scelta visiva è un posizionamento.
        </p>
      </div>
      ...
      <div ref={ctaRef} className="relative z-10 flex items-center justify-center gap-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="font-jakarta text-sm text-white/20">Visual Identity · Layout · Brand Design</span>
        </div>
      </div>
    </section>
  );
