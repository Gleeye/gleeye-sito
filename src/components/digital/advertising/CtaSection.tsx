...
export default function AdvCtaSection() {
  const sectionRef = useRef<HTMLElement>(null);

  useEffect(() => {
    const ctx = gsap.context(() => {
      gsap.from('.dadv-cta-content', {
        opacity: 0,
        y: 40,
        duration: 1.2,
        ease: 'power3.out',
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto dadv-cta-content text-center">
