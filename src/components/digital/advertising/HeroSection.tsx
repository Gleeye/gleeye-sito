...
const HEAD = { plain: ["VISIBILITÀ A PORTATA"], accent: "di mano.", inline: false };

export default function AdvHeroSection() {
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center flex-1 py-12 text-center">
        ...
        <p ref={subRef} className="mt-8 max-w-xl font-jakarta font-medium text-lg md:text-xl text-white/30 leading-relaxed">
          La pubblicità non è un costo.<br />È l&apos;unico costo che si ripaga da solo — se fatta bene.
        </p>
      </div>
      ...
      <div ref={ctaRef} className="relative z-10 flex items-center justify-center gap-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="font-jakarta text-sm text-white/20">Google Ads · Meta Ads · LinkedIn</span>
        </div>
      </div>
    </section>
  );
