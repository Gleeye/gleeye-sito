...
export default function EventsHeroSection() {
  ...
  useEffect(() => {
    gsap.to(orb1Ref.current, { x: 40, y: -50, duration: 9, repeat: -1, yoyo: true, ease: 'sine.inOut' });
    gsap.to(orb2Ref.current, { x: -55, y: 45, duration: 12, repeat: -1, yoyo: true, ease: 'sine.inOut', delay: 2 });
    gsap.to(orb3Ref.current, { x: 30, y: 55, duration: 8, repeat: -1, yoyo: true, ease: 'sine.inOut', delay: 4 });
  ...
  return (
    ...
    >
      <div ref={orb1Ref} className="pointer-events-none absolute top-[12%] left-[8%] w-[40vw] h-[40vw] max-w-[600px] max-h-[600px] rounded-full blur-[120px] opacity-20" style={{ background: '#614aa2' }} />
      <div ref={orb2Ref} className="pointer-events-none absolute top-[42%] right-[4%] w-[35vw] h-[35vw] max-w-[500px] max-h-[500px] rounded-full blur-[140px] opacity-20" style={{ background: '#4e92d8' }} />
      <div ref={orb3Ref} className="pointer-events-none absolute bottom-[8%] left-[28%] w-[28vw] h-[28vw] max-w-[400px] max-h-[400px] rounded-full blur-[100px] opacity-15" style={{ background: '#614aa2' }} />

      <div className="pointer-events-none absolute inset-0 flex items-center justify-center select-none overflow-hidden">
        <span
          className="font-satoshi font-black text-[20vw] leading-none whitespace-nowrap"
