                ...
                <article className="prose prose-lg prose-neutral max-w-none space-y-8 font-plex text-sm md:text-base leading-relaxed">
                    ...
                    <section className="space-y-4">
                        ...
                        <ul className="list-disc pl-6 space-y-2">
                            ...
                            <li><strong>Provenienza da un link condiviso:</strong> Se arrivi sul sito da un link condiviso da un nostro segnalatore, il tuo browser conserva l&apos;indicazione della provenienza (un codice e la pagina di atterraggio) e la allega alla richiesta se poi ci scrivi: serve solo ad attribuire correttamente il contatto a chi ce l&apos;ha presentato. Il dato resta per la durata della visita; viene conservato fino a 90 giorni solo se acconsenti ai cookie di profilazione, e puoi cambiare idea in ogni momento dalle <a href="/cookie-policy" className="underline">preferenze cookie</a>.</li>
                        </ul>
                    </section>
